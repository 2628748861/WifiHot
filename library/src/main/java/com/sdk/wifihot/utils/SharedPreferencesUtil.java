...
public class SharedPreferencesUtil {
    ...
    //文件名称为config
    private static final String PREFERENCE_NAME = "wifihot_sdk_config";
    //可以在此定义常亮，当做key使用
    //API的SSID
    public static final String AP1_SSID = "AP1_SSID";
    //API的PASSWORD
    public static final String AP1_PASSWORD = "AP1_PASSWORD";
    //API的CODE
    public static final String AP1_CODE = "AP1_CODE";
    //API的KEY
    public static final String AP1_KEY = "AP1_KEY";
